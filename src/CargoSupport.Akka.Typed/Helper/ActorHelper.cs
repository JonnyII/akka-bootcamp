...
public static class ActorHelper
{
    ...
    {
        return scheduler.ScheduleTellRepeatedlyCancelable(initialDelay, interval, receiver.Native, command,
            ActorRefs.Nobody);
    }
    ...
    public static void ScheduleTellRepeatedly<TCommand>(
        ...
        where TCommand : FrameworkMessages.Command
    {
        scheduler.ScheduleTellRepeatedly(initialDelay, interval, receiver.Native, command,
            sender?.Native ?? ActorRefs.Nobody, cancelable);
    }
    ...
    public static ICancelable ScheduleTellOnceCancelable<TCommand>(
        ...
        where TCommand : FrameworkMessages.Command
    {
        return scheduler.ScheduleTellOnceCancelable(initialDelay, receiver.Native, command, ActorRefs.Nobody);
    }
