...
public class FileObserver : IDisposable
{
    ...
    public FileObserver(IActorRef<TailMessage> tailActor, string absoluteFilePath)
    {
    ...
    public void Start()
    {
        ...
        _watcher = new(_fileDir, _fileNameOnly);
    ...
    void OnFileChanged(object sender, FileSystemEventArgs e)
    {
        if (e.ChangeType == WatcherChangeTypes.Changed)
        {
            ...
            _tailActor.Tell(new TailActor.Messages.FileWrite(e.Name));
        }
    }
}
